...
try {
  authInstance = initializeAuth(app, {
    ...
    // Without this, signInWithPopup/signInWithRedirect/getRedirectResult
    // can't properly initialize on this auth instance and fail immediately
    // on every call — including getRedirectResult() on pages that never
    // attempted Google sign-in at all, which is why "Could not complete
    // Google sign-in" was showing up everywhere, unconditionally.
